...
--
-- Table structure for table `bh_appointment`
--
...
--
-- Table structure for table `bh_banner`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Banner推荐位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `bh_designer`
--
...
--
-- Table structure for table `bh_designer_group`
--
...
--
-- Table structure for table `bh_lead`
--
...
--
-- Table structure for table `bh_media`
--
...
--
-- Table structure for table `bh_order`
--
...
--
-- Table structure for table `bh_product`
--
...
--
-- Table structure for table `bh_wx_user`
--
...
--
-- Dumping events for database 'baihou_life'
--

--
-- Dumping routines for database 'baihou_life'
--
