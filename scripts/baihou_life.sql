...
-- ----------------------------
BEGIN;
INSERT INTO `bh_appointment` (`appointment_id`, `appointment_no`, `user_id`, `customer_name`, `customer_phone`, `service_type`, `preferred_date`, `preferred_time`, `address`, `remark`, `product_id`, `region_id`, `status`, `assigned_to`, `admin_note`, `confirmed_at`, `completed_at`, `cancelled_at`, `create_time`, `update_time`) VALUES (1, 'APT202603100001', 1001, '张先生', '13800000001', 'measure', '2026-03-12', 'morning', '佛山市顺德区示例地址1号', '上门量尺', 1, 'foshan', 'confirmed', 3002, 'test confirm', '2026-03-15 12:55:33', NULL, NULL, '2026-03-10 15:29:30', '2026-03-15 12:55:33');
INSERT INTO `bh_appointment` (`appointment_id`, `appointment_no`, `user_id`, `customer_name`, `customer_phone`, `service_type`, `preferred_date`, `preferred_time`, `address`, `remark`, `product_id`, `region_id`, `status`, `assigned_to`, `admin_note`, `confirmed_at`, `completed_at`, `cancelled_at`, `create_time`, `update_time`) VALUES (2, 'APT202603100002', 1002, '李女士', '13800000002', 'install', '2026-03-13', 'afternoon', '广州市天河区示例地址2号', '安装服务', 2, 'guangzhou', 'confirmed', 3001, '已电话确认', NULL, NULL, NULL, '2026-03-10 15:29:30', '2026-03-10 15:29:30');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bh_lead` (`lead_id`, `user_id`, `product_id`, `product_name`, `category_id`, `name`, `phone`, `intention`, `region_id`, `status`, `assigned_to`, `source`, `follow_note`, `create_time`, `update_time`, `del_flag`) VALUES (1, 1001, 1, '云幕沙发', 10, '张先生', '13800000001', '偏现代客厅方案', 'foshan', 'following', 2002, 'product_detail', 'test follow', '2026-03-10 15:29:30', '2026-03-15 12:57:41', '0');
INSERT INTO `bh_lead` (`lead_id`, `user_id`, `product_id`, `product_name`, `category_id`, `name`, `phone`, `intention`, `region_id`, `status`, `assigned_to`, `source`, `follow_note`, `create_time`, `update_time`, `del_flag`) VALUES (2, 1002, 2, '山影茶几', 20, '李女士', '13800000002', '希望三天内上门沟通', 'guangzhou', 'following', 2001, 'home_banner', '已联系客户', '2026-03-10 15:29:30', '2026-03-10 15:29:30', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (5001, 1001, 'scene', '/profile/products/tile_1001_scene.jpg', '/profile/products/tile_1001_scene.jpg', 'webp', 102400, 'scene_01.webp', 'public', 10, '2026-03-10 15:29:30');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (5002, 1001, 'element', '/profile/products/tile_1001_elem.jpg', '/profile/products/tile_1001_elem.jpg', 'webp', 87322, 'element_01.webp', 'public', 20, '2026-03-10 15:29:30');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (5003, 1001, 'spec', '/profile/products/tile_1001_spec.jpg', '/profile/products/tile_1001_spec.jpg', 'webp', 76420, 'spec_01.webp', 'public', 30, '2026-03-10 15:29:30');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (5004, 1001, 'source', NULL, NULL, 'skp', 15728640, 'BH-001.skp', 'designer', 40, '2026-03-10 15:29:30');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (5005, 1002, 'scene', '/profile/products/wood_1002_scene.jpg', '/profile/products/wood_1002_scene.jpg', 'webp', 95421, 'scene_01.webp', 'public', 10, '2026-03-10 15:29:30');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6001, 2001, 'scene', '/profile/products/tile_2001_scene.jpg', '/profile/products/tile_2001_scene.jpg', 'jpg', 150000, 'scene_t001_1.jpg', 'public', 10, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6002, 2001, 'element', '/profile/products/tile_2001_elem.jpg', '/profile/products/tile_2001_elem.jpg', 'jpg', 120000, 'element_t001_1.jpg', 'public', 20, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6003, 2002, 'scene', '/profile/products/tile_2002_scene.jpg', '/profile/products/tile_2002_scene.jpg', 'jpg', 140000, 'scene_t002_1.jpg', 'public', 10, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6004, 2003, 'scene', '/profile/products/sofa_2003_scene1.jpg', '/profile/products/sofa_2003_scene1.jpg', 'jpg', 160000, 'scene_s001_1.jpg', 'public', 10, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6005, 2003, 'scene', '/profile/products/sofa_2003_scene2.jpg', '/profile/products/sofa_2003_scene2.jpg', 'jpg', 170000, 'scene_s001_2.jpg', 'public', 20, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (6006, 2004, 'scene', '/profile/products/sofa_2004_scene.jpg', '/profile/products/sofa_2004_scene.jpg', 'jpg', 130000, 'scene_s002_1.jpg', 'public', 10, '2026-03-13 19:57:44');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7001, 3001, 'scene', '/profile/products/tile.jpg', '/profile/products/tile.jpg', 'jpg', 150000, 'tile.jpg', 'public', 10, '2026-03-13 20:12:00');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7002, 3002, 'scene', '/profile/products/wood.jpg', '/profile/products/wood.jpg', 'jpg', 150000, 'wood.jpg', 'public', 10, '2026-03-13 20:12:00');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7003, 3003, 'scene', '/profile/products/cabinet.jpg', '/profile/products/cabinet.jpg', 'jpg', 150000, 'cabinet.jpg', 'public', 10, '2026-03-13 20:12:00');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7004, 3004, 'scene', '/profile/products/wardrobe.jpg', '/profile/products/wardrobe.jpg', 'jpg', 150000, 'wardrobe.jpg', 'public', 10, '2026-03-13 20:12:00');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7005, 3005, 'scene', '/profile/products/sofa.jpg', '/profile/products/sofa.jpg', 'jpg', 150000, 'sofa.jpg', 'public', 10, '2026-03-13 20:12:00');
INSERT INTO `bh_media` (`media_id`, `product_id`, `type`, `url`, `thumbnail_url`, `file_format`, `file_size`, `file_name`, `access_level`, `sort_order`, `create_time`) VALUES (7006, 3006, 'scene', '/profile/products/curtain.jpg', '/profile/products/curtain.jpg', 'jpg', 150000, 'curtain.jpg', 'public', 10, '2026-03-13 20:12:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bh_order` (`order_id`, `order_no`, `user_id`, `region_id`, `product_id`, `product_name`, `unit_price`, `total_amount`, `pay_amount`, `status`, `payment_method`, `transaction_id`, `remark`, `admin_note`, `tracking_no`, `paid_at`, `shipped_at`, `completed_at`, `closed_at`, `expires_at`, `create_time`, `update_time`) VALUES (1, 'ORD202603100001', 1001, 'foshan', 0, '客厅套装', 1280.00, 1280.00, 1280.00, 'completed', 'wechat_pay', 'wx202603100001', '客厅套装', 'complete test', 'SF123456789CN', '2026-03-10 09:30:00', '2026-03-15 12:57:41', '2026-03-15 12:57:41', NULL, '2026-03-10 10:00:00', '2026-03-10 15:29:30', '2026-03-15 14:57:48');
INSERT INTO `bh_order` (`order_id`, `order_no`, `user_id`, `region_id`, `product_id`, `product_name`, `unit_price`, `total_amount`, `pay_amount`, `status`, `payment_method`, `transaction_id`, `remark`, `admin_note`, `tracking_no`, `paid_at`, `shipped_at`, `completed_at`, `closed_at`, `expires_at`, `create_time`, `update_time`) VALUES (2, 'ORD202603100002', 1002, 'guangzhou', 0, '餐厅单品', 860.00, 860.00, 860.00, 'processing', 'wechat_pay', 'wx202603100002', '餐厅单品', '安排出库', NULL, '2026-03-10 08:30:00', NULL, NULL, NULL, '2026-03-10 09:00:00', '2026-03-10 15:29:30', '2026-03-15 14:57:48');
INSERT INTO `bh_order` (`order_id`, `order_no`, `user_id`, `region_id`, `product_id`, `product_name`, `unit_price`, `total_amount`, `pay_amount`, `status`, `payment_method`, `transaction_id`, `remark`, `admin_note`, `tracking_no`, `paid_at`, `shipped_at`, `completed_at`, `closed_at`, `expires_at`, `create_time`, `update_time`) VALUES (3, 'ORD1773464368741', 1003, 'chengdu', 0, '历史订单', 499.00, 499.00, 499.00, 'pending_pay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-14 13:29:29', '2026-03-14 12:59:28', '2026-03-15 14:57:48');
INSERT INTO `bh_order` (`order_id`, `order_no`, `user_id`, `region_id`, `product_id`, `product_name`, `unit_price`, `total_amount`, `pay_amount`, `status`, `payment_method`, `transaction_id`, `remark`, `admin_note`, `tracking_no`, `paid_at`, `shipped_at`, `completed_at`, `closed_at`, `expires_at`, `create_time`, `update_time`) VALUES (4, 'ORD1773464371166', 1003, 'chengdu', 0, '历史订单', 499.00, 499.00, 499.00, 'pending_pay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-14 13:29:31', '2026-03-14 12:59:31', '2026-03-15 14:57:48');
INSERT INTO `bh_order` (`order_id`, `order_no`, `user_id`, `region_id`, `product_id`, `product_name`, `unit_price`, `total_amount`, `pay_amount`, `status`, `payment_method`, `transaction_id`, `remark`, `admin_note`, `tracking_no`, `paid_at`, `shipped_at`, `completed_at`, `closed_at`, `expires_at`, `create_time`, `update_time`) VALUES (5, 'ORD1773464372508', 1003, 'chengdu', 0, '历史订单', 499.00, 499.00, 499.00, 'pending_pay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-14 13:29:33', '2026-03-14 12:59:32', '2026-03-15 14:57:48');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bh_order_item` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `line_amount`, `create_time`) VALUES (1, 1, 0, '客厅套装', 1, 1280.00, 1280.00, '2026-03-10 15:29:30');
INSERT INTO `bh_order_item` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `line_amount`, `create_time`) VALUES (2, 2, 0, '餐厅单品', 1, 860.00, 860.00, '2026-03-10 15:29:30');
INSERT INTO `bh_order_item` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `line_amount`, `create_time`) VALUES (3, 3, 0, '历史订单', 1, 499.00, 499.00, '2026-03-14 12:59:28');
INSERT INTO `bh_order_item` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `line_amount`, `create_time`) VALUES (4, 4, 0, '历史订单', 1, 499.00, 499.00, '2026-03-14 12:59:31');
INSERT INTO `bh_order_item` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `line_amount`, `create_time`) VALUES (5, 5, 0, '历史订单', 1, 499.00, 499.00, '2026-03-14 12:59:32');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品表';

-- ----------------------------
-- Records of bh_product
-- ----------------------------
BEGIN;
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1001, '现代瓷砖 800x800', 'BH-001', '柏厚生活', 'CT-800', 4, 299.00, '元/片', 0.95, '[\"chengdu\", \"foshan\"]', '[\"living_room\"]', '[\"new_house\"]', '{\"size\": \"800x800\", \"material\": \"ceramic\"}', '一期初始化示例商品', 'on_shelf', 100, '0', 'system', '2026-03-10 15:29:30', '', '2026-03-15 12:52:12');
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (1002, '原木木地板', 'BH-002', '柏厚生活', 'WD-1200', 5, 599.00, '元/平方米', 0.90, '[\"chengdu\"]', '[\"bedroom\"]', '[\"renovation\"]', '{\"size\": \"1200x190\", \"material\": \"wood\"}', '一期初始化示例商品', 'off_shelf', 90, '0', 'system', '2026-03-10 15:29:30', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (2001, '萨米特 奢石岩板 1200x2400', 'BH-T-001', '萨米特', 'SMT-YS-1224', 4, 1299.00, '元/片', 0.85, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"living_room\", \"bathroom\"]', '[\"new_house\", \"villa\"]', '{\"size\": \"1200x2400\", \"material\": \"sintered_stone\", \"thickness\": \"9mm\"}', '萨米特奢石系列大规格岩板，质感非凡', 'on_shelf', 10, '0', 'system', '2026-03-13 19:57:12', '', '2026-03-13 19:57:44');
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (2002, '马可波罗 现代灰 600x1200', 'BH-T-002', '马可波罗', 'MKL-H-612', 4, 159.00, '元/片', 0.90, '[\"chengdu\", \"foshan\"]', '[\"living_room\", \"kitchen\", \"balcony\"]', '[\"renovation\", \"new_house\"]', '{\"size\": \"600x1200\", \"finish\": \"matte\", \"material\": \"ceramic\"}', '马可波罗现代简约哑光防滑灰砖', 'on_shelf', 20, '0', 'system', '2026-03-13 19:57:12', '', '2026-03-13 19:57:44');
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (2003, '米兰极简 意式真皮沙发 3人座', 'BH-S-001', '柏厚精选', 'BH-SF-01', 8, 8999.00, '元/套', 0.80, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"living_room\"]', '[\"new_house\"]', '{\"seat\": \"3\", \"color\": \"caramel\", \"material\": \"leather\"}', '意式极简头层牛皮沙发，人体工学设计，舒适坐感', 'on_shelf', 30, '0', 'system', '2026-03-13 19:57:12', '', '2026-03-13 19:57:44');
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (2004, '北欧风 羊羔绒布艺懒人沙发', 'BH-S-002', '柏厚精选', 'BH-SF-02', 8, 1299.00, '元/件', 0.85, '[\"chengdu\", \"wuhan\"]', '[\"bedroom\", \"study_room\"]', '[\"renovation\"]', '{\"color\": \"off_white\", \"material\": \"fabric\"}', '网红款布艺懒人沙发，角落里的松弛感', 'on_shelf', 40, '0', 'system', '2026-03-13 19:57:12', '', '2026-03-13 19:57:44');
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3001, '蒙娜丽莎 抗菌薄板瓷砖 600x1200', 'BH-T-003', '蒙娜丽莎', 'MN-6120', 4, 129.00, '元/片', 0.90, '[\"chengdu\", \"foshan\"]', '[\"living_room\", \"bathroom\"]', '[\"minimalist\", \"wabi_sabi\"]', '{\"size\": \"600x1200\", \"material\": \"ceramic\"}', '抗菌自洁釉面，适用于极简风设计', 'on_shelf', 10, '0', 'system', '2026-03-13 20:12:00', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3002, '大自然 橡木实木复合地板', 'BH-W-001', '大自然', 'DZR-X-1200', 5, 299.00, '元/平米', 0.85, '[\"chengdu\", \"foshan\"]', '[\"bedroom\", \"living_room\"]', '[\"healing\", \"minimalist\"]', '{\"size\": \"1200x150\", \"material\": \"wood\"}', '环保等级ENF级，治愈系原木色', 'on_shelf', 20, '0', 'system', '2026-03-13 20:12:00', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3003, '欧派 极简一字型橱柜', 'BH-C-001', '欧派', 'OP-K-001', 6, 9999.00, '元/套', 0.80, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"kitchen\"]', '[\"minimalist\"]', '{\"style\": \"straight\", \"material\": \"quartz_stone\"}', '极简高柜内嵌电器，防污门板', 'on_shelf', 30, '0', 'system', '2026-03-13 20:12:00', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3004, '索菲亚 铝框玻璃对开门衣柜', 'BH-CW-001', '索菲亚', 'SFY-W-001', 7, 7999.00, '元/套', 0.80, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"bedroom\"]', '[\"minimalist\", \"healing\"]', '{\"style\": \"aluminum\", \"material\": \"glass\"}', '窄边铝框，茶色玻璃，自带智能感应灯', 'on_shelf', 40, '0', 'system', '2026-03-13 20:12:00', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3005, '顾家家居 豆腐块模块沙发', 'BH-S-003', '顾家家居', 'GJ-SF-03', 8, 4599.00, '元/套', 0.85, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"living_room\"]', '[\"wabi_sabi\", \"healing\"]', '{\"seats\": \"4\", \"material\": \"fabric\"}', '科技布防猫抓系列，自由模块拼合', 'on_shelf', 50, '0', 'system', '2026-03-13 20:12:00', '', NULL);
INSERT INTO `bh_product` (`id`, `name`, `sku_code`, `brand`, `model`, `category_id`, `guide_price`, `price_unit`, `designer_discount`, `regions`, `space_tags`, `scene_tags`, `spec_params`, `description`, `status`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3006, '日式 亚麻透光遮纱窗帘', 'BH-CT-001', '柏厚精选', 'BH-CT-001', 9, 499.00, '元/米', 0.90, '[\"chengdu\", \"foshan\", \"wuhan\"]', '[\"living_room\", \"bedroom\"]', '[\"wabi_sabi\", \"healing\"]', '{\"shading\": \"50%\", \"material\": \"linen\"}', '日式侘寂风，自然垂坠感强', 'on_shelf', 60, '0', 'system', '2026-03-13 20:12:00', '', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
